...
" let s:gui10        = '{{base10-hex}}{{^base10-hex}}{{base00-hex}}{{/base10-hex}}'
" let s:gui11        = '{{base11-hex}}{{^base11-hex}}{{base00-hex}}{{/base11-hex}}'
" let s:gui12        = '{{base12-hex}}{{^base12-hex}}{{base08-hex}}{{/base12-hex}}'
" let s:gui13        = '{{base13-hex}}{{^base13-hex}}{{base0A-hex}}{{/base13-hex}}'
" let s:gui14        = '{{base14-hex}}{{^base14-hex}}{{base0B-hex}}{{/base14-hex}}'
" let s:gui15        = '{{base15-hex}}{{^base15-hex}}{{base0C-hex}}{{/base15-hex}}'
" let s:gui16        = '{{base16-hex}}{{^base16-hex}}{{base0D-hex}}{{/base16-hex}}'
" let s:gui17        = '{{base17-hex}}{{^base17-hex}}{{base0E-hex}}{{/base17-hex}}'
...
"   \ '#{{base05-hex}}',
"   \ '#{{base03-hex}}',
"   \ '#{{base12-hex}}{{^base12-hex}}{{base08-hex}}{{/base12-hex}}',
"   \ '#{{base14-hex}}{{^base14-hex}}{{base0B-hex}}{{/base14-hex}}',
"   \ '#{{base13-hex}}{{^base13-hex}}{{base0A-hex}}{{/base13-hex}}',
"   \ '#{{base16-hex}}{{^base16-hex}}{{base0D-hex}}{{/base16-hex}}',
"   \ '#{{base17-hex}}{{^base17-hex}}{{base0E-hex}}{{/base17-hex}}',
"   \ '#{{base15-hex}}{{^base15-hex}}{{base0C-hex}}{{/base15-hex}}',
"   \ '#{{base07-hex}}'
" \]
...
call <sid>hi('StatusLine',     s:gui04, s:gui01, s:cterm04, s:cterm01, 'none', '') " XXX
call <sid>hi('StatusLineNC',   s:gui04, s:gui00, s:cterm03, s:cterm01, 'none', '') " XXX
hi! link StatusLineTerm StatusLine
hi! link StatusLineTermNC StatusLineNC
hi! link TabLine StatusLine
call <sid>hi('TabLineSel',     s:gui05, s:gui02, s:cterm01, s:cterm04, 'none', '') " XXX
...
if has('nvim-0.8.0')
  ...
  call <sid>hi('@variable.member',            s:gui05, '', s:cterm06, '', 'none', '') " XXX
